...
import {AvionFooterListType, BrandDifferentCardType, FooterListType, NavListType, NewCeramicsType, OurPopularProductsType, productListType, } from "@/utils/types/types";
